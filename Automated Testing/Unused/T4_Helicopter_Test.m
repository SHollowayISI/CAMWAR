...
scenario.environment = struct( ...
    ...
    'gnd_res',              1, ...         % Distance between targets
    ...
    'pt_tgt',               true, ...          % Single point target T/F
    'tgt_pos',              [700; 100; -25], ...    % Discrete target location
    'tgt_vel',              [10; 0; 0], ...      % Discrete target velocity
    'tgt_rcs',              db2pow(10));         % Discrete target RCS
...
scenario.radarsetup = struct( ...
    ...
    'int_start',    447, ...            % Range to start performing range bin combination
